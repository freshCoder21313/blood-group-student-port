                ...
                <form method="POST" action="{{ route('application.personal.update', $application) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="middle_name" class="block mt-1 w-full" type="text" name="middle_name" :value="old('middle_name', $student->middle_name)" />
                        ...
                        <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="nationality" class="block mt-1 w-full" type="text" name="nationality" :value="old('nationality', $student->nationality ?? 'Kenya')" />
                        ...
                        <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="passport_number" class="block mt-1 w-full" type="text" name="passport_number" :value="old('passport_number', $student->passport_number)" />
                             <p class="text-xs text-gray-500 mt-1">Encrypted at rest</p>
                        ...
                        <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $student->city)" />
                        ...
                        <!-- County -->
                         <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="county" class="block mt-1 w-full" type="text" name="county" :value="old('county', $student->county)" />
                        ...
                        <div>
                            ...
                            <x-ui.input :disabled="$readonly" id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code', $student->postal_code)" />
