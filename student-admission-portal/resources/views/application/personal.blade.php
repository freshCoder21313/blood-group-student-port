                ...
                <form method="POST" action="{{ route('application.personal.update', $application) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="first_name" class="block mt-1 w-full" type="text" name="first_name" :value="old('first_name', $student->first_name)" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="middle_name" class="block mt-1 w-full" type="text" name="middle_name" :value="old('middle_name', $student->middle_name)" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="old('last_name', $student->last_name)" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="date_of_birth" class="block mt-1 w-full" type="date" name="date_of_birth" :value="old('date_of_birth', optional($student->date_of_birth)->format('Y-m-d'))" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="nationality" class="block mt-1 w-full" type="text" name="nationality" :value="old('nationality', $student->nationality ?? 'Kenya')" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="national_id" class="block mt-1 w-full" type="text" name="national_id" :value="old('national_id', $student->national_id)" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="passport_number" class="block mt-1 w-full" type="text" name="passport_number" :value="old('passport_number', $student->passport_number)" />
                             <p class="text-xs text-gray-500 mt-1">Encrypted at rest</p>
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <textarea id="address" name="address" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" rows="3">{{ old('address', $student->address) }}</textarea>
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="city" class="block mt-1 w-full" type="text" name="city" :value="old('city', $student->city)" />
                        ...
                        <!-- County -->
                         <div>
                            ...
                            <x-ui.text-input id="county" class="block mt-1 w-full" type="text" name="county" :value="old('county', $student->county)" />
                        ...
                        <div>
                            ...
                            <x-ui.text-input id="postal_code" class="block mt-1 w-full" type="text" name="postal_code" :value="old('postal_code', $student->postal_code)" />
