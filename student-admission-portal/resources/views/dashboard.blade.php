                    ...
                    <div class="space-y-6">
                        <div class="flex items-center justify-between border-b pb-4">
                            <div>
                                ...
                                <p class="text-gray-600">Student Code: <span
                                        class="font-mono font-bold text-primary-600">{{ $application->student_code }}</span>
                                </p>
                            </div>
                ...
                @elseif(isset($application) && $application)
                    <div class="text-center">
                        @if(in_array($application->status, ['pending_approval', 'approved', 'rejected']))
                            <h3 class="text-lg font-medium text-gray-900 mb-2">Application
                                #{{ $application->application_number }}</h3>
                        ...
                        @else
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2.5 mb-6 max-w-md mx-auto">
                                <div class="bg-primary-600 h-2.5 rounded-full"
                                    style="width: {{ ($application->current_step / $application->total_steps) * 100 }}%"></div>
                            </div>
                            ...
                            @php
                                ...
                                if (isset($application)) {
                                    switch ($application->current_step) {
                                        case 1:
                                            $continueRoute = route('application.wizard', $application) . '#step-1';
                                            break;
                                        case 2:
                                            $continueRoute = route('application.wizard', $application) . '#step-2';
                                            break;
                                        case 3:
                                            $continueRoute = route('application.wizard', $application) . '#step-3';
                                            break;
                                        case 4:
                                            $continueRoute = route('application.wizard', $application) . '#step-4';
                                            break;
                                        default:
                                            $continueRoute = route('dashboard');
                                    }
                                }
                            @endphp
