    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <p class="text-gray-600">Overview of student admissions.</p>
            </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach(\App\Models\Application::with(['student', 'program'])->latest()->take(5)->get() as $app)
                                    <tr>
                                        <td class="px-6 py-4">{{ $app->student->first_name ?? 'N/A' }} {{ $app->student->last_name ?? '' }}</td>
                                        <td class="px-6 py-4">{{ $app->program->code ?? 'N/A' }}</td>
                                        <td class="px-6 py-4">
